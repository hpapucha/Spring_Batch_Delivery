	...
	public Job deliverPackageJob() {
		return this.jobBuilderFactory.get("deliverPackageJob")
				...
				.next(driveToAddressStep())
					.on("FAILED").to(storePackageStep()) //If the address is incorrect store the package
				.from(driveToAddressStep()) //If address is correct execute next steps
					.on("*").to(decider())
						.on("PRESENT").to(givePackageToCustomerStep()) //When customer is present give package
